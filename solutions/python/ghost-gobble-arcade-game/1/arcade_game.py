...
def score(touching_power_pellet, touching_dot):
    ...
    """
    touch_pac = touching_power_pellet or touching_dot
    return touch_pac
...
def lose(power_pellet_active, touching_ghost):
    ...
    """
    not_power = power_pellet_active and touching_ghost
    if not_power:
        return False
    if touching_ghost:
        return True
...
def win(has_eaten_all_dots, power_pellet_active, touching_ghost):
    ...
    """
    alive = has_eaten_all_dots and (not touching_ghost or power_pellet_active)
    return alive   
